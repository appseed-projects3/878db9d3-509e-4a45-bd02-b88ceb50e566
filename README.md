...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-19 10:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/878db9d3-509e-4a45-bd02-b88ceb50e566.git
$ cd 878db9d3-509e-4a45-bd02-b88ceb50e566
```
